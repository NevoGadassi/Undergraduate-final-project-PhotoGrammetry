...
@Generated("boofcv.alg.distort.brown.TestAddBrownPtoN_F64")
public class TestAddBrownPtoN_F32 extends BoofStandardJUnit {
	/**
	...
	public void againstManual( float t1, float t2 ) {
		...
		AddBrownPtoN_F32 alg = new AddBrownPtoN_F32().setK(fx, fy, skew, xc, yc).
