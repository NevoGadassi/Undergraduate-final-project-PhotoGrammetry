...
@Generated("boofcv.alg.distort.pinhole.TestPinholeNtoP_F64")
public class TestPinholeNtoP_F32 extends BoofStandardJUnit {

	@Test void basicTest() {
		CameraPinholeBrown p = new CameraPinholeBrown().fsetK(1, 2, 3, 4, 5, 200, 300);

		FMatrixRMaj K = PerspectiveOps.pinholeToMatrix(p, (FMatrixRMaj)null);
