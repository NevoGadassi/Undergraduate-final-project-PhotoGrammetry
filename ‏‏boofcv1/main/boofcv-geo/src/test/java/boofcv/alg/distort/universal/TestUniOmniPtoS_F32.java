...
@Generated("boofcv.alg.distort.universal.TestUniOmniPtoS_F64")
public class TestUniOmniPtoS_F32 extends BoofStandardJUnit {
	/**
	...
	public static CameraUniversalOmni createModel(float mirror) {
		...
		model.fsetTangential(0.001f,0.002f);
		return model;
	}
}
