...
@Generated("boofcv.alg.distort.spherical.TestCameraToEquirectangular_F64")
class TestCameraToEquirectangular_F32 extends TestEquirectangularDistortBase_F32 {
	...
	private void assertPointing(CameraToEquirectangular_F32 alg , int x , int y , float nx , float ny , float nz )
	{
