...
@Generated("boofcv.alg.distort.TestLensDistortionOps_F64")
public class TestLensDistortionOps_F32 extends BoofStandardJUnit {
	...
	@Test void centerBoxInside() {
		...
		// easy cases
		checkInsideBorder(new Affine2D_F32(1,0,0,1,1,2),false);
		checkInsideBorder(new Affine2D_F32(1,0,0,2,1,2),false);

		// rotated by 90 degrees, still easy
		checkInsideBorder(new Affine2D_F32(0,-1,1,0,1,2),false);
		checkInsideBorder(new Affine2D_F32(-1,0,0,-1,1,2),false);
