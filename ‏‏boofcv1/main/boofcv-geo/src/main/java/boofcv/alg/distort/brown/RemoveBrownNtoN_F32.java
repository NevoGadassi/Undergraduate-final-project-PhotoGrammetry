...
public class RemoveBrownNtoN_F32 implements Point2Transform2_F32 {
	...
	public RemoveBrownNtoN_F32 setDistortion( @Nullable /**/double[] radial, /**/double t1, /**/double t2 ) {
	...
	@Override public RemoveBrownNtoN_F32 copyConcurrent() {
		var ret = new RemoveBrownNtoN_F32();
		ret.tol = tol;
