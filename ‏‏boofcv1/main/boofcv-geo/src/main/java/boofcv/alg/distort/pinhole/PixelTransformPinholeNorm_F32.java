 ...
 * @author Peter Abeles
 */
@Generated("boofcv.alg.distort.pinhole.PixelTransformPinholeNorm_F64")
public class PixelTransformPinholeNorm_F32 implements PixelTransform<Point2D_F32> {
	...
	@Override public void compute( int x, int y, Point2D_F32 out ) {
