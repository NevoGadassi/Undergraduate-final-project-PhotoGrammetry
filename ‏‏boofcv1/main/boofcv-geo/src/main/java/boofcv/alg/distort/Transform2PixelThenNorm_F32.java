...
@Generated("boofcv.alg.distort.Transform2PixelThenNorm_F64")
public class Transform2PixelThenNorm_F32 implements Point2Transform2_F32 {
	Point2Transform2_F32 first;
	PinholePtoN_F32 p_to_n = new PinholePtoN_F32();

	public Transform2PixelThenNorm_F32( Point2Transform2_F32 first ) {
		this.first = first;
	}
	...
	@Override
	public Transform2PixelThenNorm_F32 copyConcurrent() {
		var ret = new Transform2PixelThenNorm_F32();
