...
public class AddBrownNtoN_F32 implements Point2Transform2_F32 {
	 ...
	 */
	public AddBrownNtoN_F32 setDistortion( @Nullable /**/double[] radial, /**/double t1, /**/double t2 ) {
	...
	@Override public AddBrownNtoN_F32 copyConcurrent() {
		var ret = new AddBrownNtoN_F32();
