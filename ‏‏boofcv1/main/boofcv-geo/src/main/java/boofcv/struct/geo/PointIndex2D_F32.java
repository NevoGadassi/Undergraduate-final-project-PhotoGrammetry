...
public class PointIndex2D_F32 extends PointIndex<PointIndex2D_F32, Point2D_F32> {
	...
	public PointIndex2D_F32() {super(new Point2D_F32());}
	...
	public PointIndex2D_F32 setTo( float x, float y, int index ) {
		this.p.setTo(x, y);
		this.index = index;
		return this;
	}
	...
	public PointIndex2D_F32 copy() {
		return new PointIndex2D_F32(p, index);
	}

	@Override public String toString() {
		return "PointIndex2D_F32{" +
				"index=" + index +
				", p={ " + p.x + " , " + p.y + " }" +
				'}';
	}
