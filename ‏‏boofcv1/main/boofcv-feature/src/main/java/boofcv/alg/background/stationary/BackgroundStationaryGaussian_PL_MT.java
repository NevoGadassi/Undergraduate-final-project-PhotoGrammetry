...
public class BackgroundStationaryGaussian_PL_MT<T extends ImageGray<T>> extends BackgroundStationaryGaussian<Planar<T>> {
	 ...
	 */
	public BackgroundStationaryGaussian_PL_MT( float learnRate, float threshold,
	...
	@Override public void updateBackground( Planar<T> frame ) {
		...
		BoofConcurrency.loopBlocks(0, frame.height, 20, storageInput, (inputPixel, idx0, idx1) -> {
