...
@Generated("boofcv.alg.filter.convolve.noborder.ConvolveImageUnrolled_SB_U8_I8_Div")
public class ConvolveImageUnrolled_SB_MT_U8_I8_Div {
	...
	public static boolean vertical( Kernel1D_S32 kernel,
								   GrayU8 image, GrayI8 dest, int divisor, GrowArray<DogArray_I32> work ) {
	...
	public static void horizontal3( Kernel1D_S32 kernel , GrayU8 image, GrayI8 dest , int divisor )
	{
	...
	public static void vertical3( Kernel1D_S32 kernel, GrayU8 src, GrayI8 dst , int divisor, @Nullable GrowArray<DogArray_I32> workspaces )
	{
	...
	public static void vertical5( Kernel1D_S32 kernel, GrayU8 src, GrayI8 dst , int divisor, @Nullable GrowArray<DogArray_I32> workspaces )
	{
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dst.data;
	...
	public static void vertical7( Kernel1D_S32 kernel, GrayU8 src, GrayI8 dst , int divisor, @Nullable GrowArray<DogArray_I32> workspaces )
	{
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dst.data;
	...
	public static void vertical11( Kernel1D_S32 kernel, GrayU8 src, GrayI8 dst , int divisor, @Nullable GrowArray<DogArray_I32> workspaces )
	{
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dst.data;
	...
	public static void convolve3( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , @Nullable GrowArray<DogArray_I32> workspaces ) {
		...
		BoofConcurrency.loopBlocks(kernelRadius, height-kernelRadius, kernelWidth, workspaces, (work, y0, y1)->{
	...
	public static void convolve5( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , @Nullable GrowArray<DogArray_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, DogArray_I32::new);
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dest.data;
	...
	public static void convolve7( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , @Nullable GrowArray<DogArray_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, DogArray_I32::new);
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dest.data;
	...
	public static void convolve9( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , @Nullable GrowArray<DogArray_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, DogArray_I32::new);
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dest.data;
