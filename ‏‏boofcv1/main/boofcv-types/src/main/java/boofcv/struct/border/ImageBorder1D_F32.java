 ...
 * inside the image. For {@link ImageBorder_F32}.
 *
 * @author Peter Abeles
 */
@Generated("boofcv.struct.border.ImageBorder1D_F64")
public class ImageBorder1D_F32 extends ImageBorder_F32 implements ImageBorder1D {
	BorderIndex1D rowWrap;
	BorderIndex1D colWrap;

	public ImageBorder1D_F32( FactoryBorderIndex1D factory ) {
