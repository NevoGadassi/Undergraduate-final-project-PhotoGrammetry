...
@Generated("boofcv.struct.sparse.SparseScaleSample_F64")
public abstract class SparseScaleSample_F32<T extends ImageGray<T>>
		implements SparseImageSample_F32<T> {
	protected T input;
