...
@Generated("boofcv.struct.packed.TestPackedArrayPoint4D_F64")
public class TestPackedArrayPoint4D_F32 extends GenericPackedArrayChecks<Point4D_F32> {

	@Override protected PackedArray<Point4D_F32> createAlg() {
		return new PackedArrayPoint4D_F32();
	}
