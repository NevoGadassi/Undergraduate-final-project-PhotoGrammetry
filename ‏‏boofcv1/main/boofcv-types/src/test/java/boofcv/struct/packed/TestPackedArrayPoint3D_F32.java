...
@Generated("boofcv.struct.packed.TestPackedArrayPoint3D_F64")
public class TestPackedArrayPoint3D_F32 extends GenericPackedArrayChecks<Point3D_F32> {

	@Override protected PackedArray<Point3D_F32> createAlg() {
		return new PackedArrayPoint3D_F32();
	}
