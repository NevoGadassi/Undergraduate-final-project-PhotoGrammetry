...
@Generated("boofcv.struct.packed.TestPackedArrayPoint2D_F64")
public class TestPackedArrayPoint2D_F32 extends GenericPackedArrayChecks<Point2D_F32> {

	@Override protected PackedArray<Point2D_F32> createAlg() {
		return new PackedArrayPoint2D_F32();
	}
